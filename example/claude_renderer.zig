...
/// 8x8 block element font bitmap data
/// Author: Daniel Hepper <daniel@hepper.net>
/// URL: https://github.com/dhepper/font8x8
const font8x8_block: [32][8]u8 = .{
...
fn convertToAscii(
    ...
    const bm = &(try getCharBitmap(ascii_char));
...
pub fn renderGameFrame(
    ...
    var frame = try createImage(allocator, game_width, game_height, 3);
